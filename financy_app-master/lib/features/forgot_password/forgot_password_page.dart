    ...
    switch (state.runtimeType) {
      ...
      case ForgotPasswordStateError:
        ...
        showCustomModalBottomSheet(
          context: context,
          content: (_forgotPasswordController.state as ForgotPasswordStateError).message,
          ...
          children: [
            Text(
              ...
              style: AppTextStyles.mediumText36.copyWith(
                color: AppColors.purpleOne, // Cor roxa
              ),
            ),
            ...
            Text(
              ...
              style: AppTextStyles.mediumText16w500.copyWith(color: AppColors.purpleTwo), // Cor roxa
              textAlign: TextAlign.center,
            ),
            Padding(
