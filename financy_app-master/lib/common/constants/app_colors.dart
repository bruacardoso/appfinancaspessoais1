...
class AppColors {
  ...
  static const Color purpleOne = Color(0xFF6F2DBD);
  static const Color purpleTwo = Color(0xFFA43FBB);
  static const Color purpleThree = Color(0xFFD45FD2);
  static const Color purpleFour = Color(0xFFE8A4E5);
